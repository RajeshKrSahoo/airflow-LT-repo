...
def _choose_best_model(ti):
    ...
    accuracy=ti.xcom_pull(key='model_accuracy',task_ids=[
...
with DAG('xcom_dag', schedule_interval='@daily', default_args=default_args, catchup=False) as dag:
    ...
    downloading_data = BashOperator(
        ...
        do_xcom_push=False #for disabling default push
    )
    ...
    choose_model >>[in_accurate,accurate] >> storing
    # storing >> downloading_data
